...
*/
	return ''
		 ...
		 + '<tr>'
		 + '<td width="163px">'
		 + '<a href="javascript:" onclick="ds_py();"><img src="/common/images/calendar/btn_first.gif" alt="이전년도"/></a> '
		 + '<a href="javascript:" onclick="ds_pm();"><img src="/common/images/calendar/btn_prev.gif" alt="이전달"/></a> '
		 + '&nbsp;&nbsp;' + t + '&nbsp;&nbsp;'
		 + '<a href="javascript:" onclick="ds_nm();"><img src="/common/images/calendar/btn_next.gif" alt="다음달"/></a> '
		 + '<a href="javascript:" onclick="ds_ny();"><img src="/common/images/calendar/btn_last.gif" alt="다음년도"/></a>'
		 + '</td>'
		 + '<td align="right"><img src="/common/images/calendar/btn_calendar_c.gif" alt="달력선택취소" onclick="ds_hi();" style="cursor:pointer"/></td>'
		 + '</tr>'
		 + '</table>'
		 + '</td></tr>'
...
function ds_sh(t, ldepth, tdepth) {
	...
	the_top = ds_gettop(t) + t.offsetHeight + -460;
...
function getCalendar(objName, syear, smonth, str) {
	...
	with(document.getElementById(id)) {
		...
		if(style.display == 'block') {
			...
			self.eval(name).location.replace('/common/ddc_media_calendar.html?syear=' + syear + '&smonth=' + smonth);
